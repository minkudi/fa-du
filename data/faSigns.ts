...
,
  ...
  tonGeneral: "plutot_favorable",   
  fetiches: ["Tohossou", "Hohovi (jumeaux)", "Hêbiosso", "Lissa", "Gu", "Loko", "Dan"],
  feuillesLiturgiques: ["Srèsrèvikè (fon)"],
  couleursPreferes: [""],
  devises: [
    "Lêguêdê govi jêto ma citô.. Lêguêdê govi (petite calebasse où l'on conserve poudres et talismans) tombe dans l’eau mais ne s’immerge pas. Si le «favi» tombe dans un malheur quelconque, il s’en tirera facilement.",
    "E mô nô nô jê tô do kô bo nô ba ka do oun nan,mon hun gbè gblé. Celui qui est tombé dans la rivière jusqu’au cou ne cherche pas une calebasse pour se désaltérer. Il n’a plus qu’à boire. Le bonheur du «favi» dépendra de lui-même.",
    "Ga jê tô,bo hô lo. L’ancre mouille et la pirogue s’arrête. Le consultant, longtemps ballotté par les vicissitudes de la vie, finira par trouver en Ka-Mêdji son point de stabilité.",
    "Haoussa hossu ma yiku do kun mêvo. Le roi haoussa ne meurt jamais autrement que riche. Il en sera de même pour le «favi».",
    "Attin ku tô, moin ma ku tô. Tous les arbres se noient, mais le bambou résiste. Le «favi» échappera toujours à ses ennemis.",
  ],
  interdits: [
    "Poisson fumé recourbé( Houé Hiha)",
    "Voandzou(Azígokwin en fon)",
    "Patate douce",
    "Serpents",
    "Crocodile (lò en fon)",
    "Pangolin (azô en fon)",
