...
export const faMotherSigns: FaSign[] = [
  {
    ...
    fetiches: ["Mahu-Lissa", "Dan", "Gbadu", "Hbiosso", "Sakpata"],
    feuillesLiturgiques: ["Fenie", "Manioc kotam", "Zuno", "Affam"],
    ...
    devises: [
      ...
      "O fa jiogb ! Jamais la route de la mort n'est fermée au chien. Jamais non plus la route n'est fermée à aklassu vautour dans les airs.",
      "Aklassu fond sur un corps sans vie et dit: Je suis tombé grâce à jiogb, sur un cadavre.",
      "O fa jiogb ! Jamais la foudre n'atteint le rongeur Aguidigbahun au cœur de la montagne. Le Fa vi sera protégé."
    ],
    interdits: [
      "Vin de palme (Attan)",
      "Chair du chien",
    ...
    sacrifices: ["Adorer le ftiche Dan-Ayidohudo", "Adorer les ftiches Lissa et Tohossou"],
  ...
  },
  {
    ...
    fetiches: ["Kututo", "Gbadu", "Tohossou", "Dan", "Sakpata", "Hbiosso"],
    feuillesLiturgiques: ["Sisrm", "Gbagbada", "Ahwim", "Yassak"],
    couleursPreferes: ["Noir"],
    devises: [
      "Ykou Mdji ! Zan Ku ho dodo jiou. La nuit est tombée et les trous font peur. Allusion à la nuit et au royaume des morts, l'au-delà dont Ykou est le maître.",
      "Go do atin hu ma hu atin. Go do kan hu man hu kan. La minceur de l'arbre ne tue pas l'arbre, le nœud de la corde ne tue pas la corde, les aspérités de la peau du crocodile ne tuent pas le crocodile. Le consultant échappera à la maladie, aux accidents et à ses ennemis.",
      "Un poisson est tombé du ciel au pays alangba. Les enfants du roi se sont écriés c'est la mort et Fa ayidgwin leur dit: Prenez ce poisson et allez le faire cuire, la mort n'a rien là-dedans.",
      "Zan non ku nu ku m mon j do avo wi m an. L'œil ne peut voir à travers un pagne noir dans la nuit noire. La mort, les accidents et les ennemis n'atteindront guère le consultant s'il exécute correctement les sacrifices prescrits."
    ],
    interdits: [
      "Nu Ku Ku (viande de bêtes et d'oiseaux crevés non tués)",
      "Toute nourriture offerte en sacrifice aux kututo (culte des ancêtres)",
      "Fruit noir de l'arbre",
      "Vin de palme",
      "Pagnes rouges",
      "Ne pas enfumer ou brûler les fourmis noires",
      "Ne pas utiliser pour les sacrifices des épines ou du bois d'un arbre à épines",
      "Viande de Honsu-Honsu, Aklassu, Dgbo, Afanku",
      "Chat",
      "Coq"
    ],
    sacrifices: ["Faire des offrandes aux kututo (culte des morts ou ancêtres)", "Dan", "Tohossou", "Sovi"],
  ...
  },
  {
    ...
    fetiches: ["Gu", "Agu", "Lissa", "Loko", "Tohossou"],
    feuillesLiturgiques: ["Wlkpkp (fon)"],
    couleursPreferes: ["Marron tirant sur le rouge"],
    devises: [
      "Gbodo tom na gnon do gbodo hossu sito. La prospérité du pays gbodo ne dépendra que de son roi. Ainsi donc, le bonheur ou la réussite du consultant dépendra de lui-même.",
      "Akw d m-dagb d m-Afo no yi gbodo tom an Lan na wi w. Il y a des richesses et de bonnes choses, mais nul ne peut pénétrer dans le pays de gbodo. Les bêtes féroces le mangeraient.",
      "Ajanu hla do yuyu ! na du nu. Si l'hyène jappe, c'est qu'il cherche à manger. Le favi ne sera pas pauvre.",
      "Gbo d do - gbo d w n klon. L'oranger planté par l'un est arraché par l'autre. Un jour le Fa annonce que la maladie est grave, mais le lendemain, il dit qu'elle est bénigne.",
      "Gbodo tom gnon l hla nadufnu. Que le pays gbodo soit bon ou mauvais, l'hyène y trouvera de quoi manger. Celui à qui Dieu a donné quelque chose l'obtient coup sûr."
    ],
    interdits: [
      "Tout animal trouvé mort ou tué par décapitation",
      "Adjagb (pâte faite de feuilles du haricot et de la farine de maïs)",
      "La consommation du vin de palme",
      "L'usage de la chair ou viande du chien",
      "Adgbanlin (girafe)",
      "Hia (hyène)",
      "Adjinaku (éléphant)",
      "Coq (commun à tous les signes majeurs)"
    ],
    sacrifices: ["Adorer Gu, Tohossou, Kututo", "K di wo-Fo do", "Faire aussi des sacrifices de viande et de chapeau"],
  ...
  },
  {
    ...
    feuillesLiturgiques: ["Dsrgu ou dsrssigu (fon)"],
    couleursPreferes: ["Noir et bigarrures", "Jaune et rouge (quelquefois pour les sacrifices aux femmes)"],
// Suite du fichier DI-MEDJI (position 4)
    devises: [
      "Ku naho kpako, Azon naho kpako. La mort, la maladie et le procès ne peuvent t'atteindre.",
      "Le lopard n'attrape pas le chien enfermé dans une cage métallique résistante.",
      "Si une grosse viande est perdue, allez la chercher sur la claie où on la fait cuire.",
      "Une rive ne peut se déplacer pour aller faire la guerre à la rive opposée."
    ],
    interdits: [
      "N Nu D Nu (toute viande ou nourriture consacrée à N, D)",
      "Viande du coq (interdit commun à tous les signes)",
      "Azwi ou Azui (le lièvre)",
      "Les singes Zin wo, Klan, Xa ou Za",
      "Tous les jumeaux",
      "Gnibu (bœuf)",
      "Arbre Za, Kloukunpois d'angol",
      "Adjinaku (éléphant), Kinni Kinni (lion), Lopard (kpv), Hla (hyène), Alului, coq"
    ],
  ...
  },
  {
    ...
    tonGeneral: "plutot_favorable",
    fetiches: ["Hbiosso", "Yalod", "D", "Na", "Gu", "Tovodoun", "Lissa"],
    feuillesLiturgiques: ["Ologoncece (Yoruba)", "Kpaklssi (Fon)", "Xexem", "Dindin fundin", "Amj"],
    couleursPreferes: ["Rouge (symbole du feu, de la foudre, de la colère, du sang, de l'accident)"],
    devises: [
      "Akpa miu, ho x si. Gb t mi m ahossu j hun mi hon. Quand Akp est en colère, tous les oiseaux s'envolent. Lorsque les hommes voient leur roi, ils le craignent.",
      "Nu kun mian n ton kan n. Qui dit œil rouge ne dit pas œil crevé. Il s'agit des souffrances qu'engendrent les épreuves de la vie.",
      "Nu kun do v n Attakin, na n swi do Akpam n. Les yeux qui se moquent des brûlures d'attakin ne se tiennent pas tranquilles dans leurs globes.",
      "Hon do gb, Gu w na gni Ahossua. Tant que Hon l'aigle est en vie, l'oiseau rouge Gu ne peut prendre le nom de roi."
    ],
    interdits: [
      "Tout ce qui est rouge (vêtement, meubles, bijoux, plumes de la queue de Ks perroquet, teinture Sokpakp)",
      "Ne doit pas épouser une femme de teint clair, ni une fticheuse Sakpatassi, ni Hbiossossi",
      "Ne pas consommer la viande des singes Klan et Ajissilw",
      "Oiseaux Akp, Drgbagw, Gu, Aklassu, Ututu",
      "Animal Agbanlin (Girafe)",
      "Ne pas faire usage des fruits rouges Gogozotin et Cili vovo"
    ],
    sacrifices: [
      "Adorer les ftiches Hbiosso, d, Yalod et Gu",
      "Faire des sacrifices de nu kun min avec des régimes de palmes et de tissu rouge, tous les ans"
    ],
  ...
  },
  {
    ...
    feuillesLiturgiques: ["Atoladola (yoruba)", "Godok ou gninsinkin (fon)", "Mafowok omomi (Yoruba)"],
    couleursPreferes: ["Wanlan-wanlan (moucheté, bigarré)"],
    devises: [
      "Attakin kpo li kpo si hu wa ahuandan n. Si Attakin petits piments rouges déclare la guerre à Li mil, Attakin l'emportera toujours.",
      "S Lissa ma dgb do to da, ahuan n gbaa. Sans l'ordre de S Lissa, la guerre ne brisera pas un pays.",
      "Zan m n n aga nufindoh. La natte ordinaire findoh ne pose jamais sous une autre natte. Celle-ci est la plus jolie des deux.",
      "Ahuan m n gba Kuta. La guerre ne peut casser les rochers."
    ],
    interdits: [
  ...
  },
  {
    ...
    devises: [
      "Afafa w n kon din huaa. C'est l'éventail qui sèche la sueur. Le favi sera défendu contre tous ses ennemis.",
      "Adjidja non ba kpssi ho n glo. Le porc-épic courtise la femelle du lopard et échappe aux crocs puissants du mâle.",
      "Suru ni njba (haoussa en yoruba). L'homme patient devient roi du pays haoussa.",
  ...
  },
  {
    ...
    devises: [
      ...
      "Adkpo sakotow m n si kdo, ho n vit xo tom to n jayi. Le contenu du sac fermant à coulisse, même retourné, ne tombe pas au sol.",
      "Dh m n hu Aklaku dgbo. Le filet de pêche ne prend pas l'hippopotame."
    ],
    interdits: [
      "Viande de singe",
      "Haricot Akpakoun",
      "Attacher soi-même des fagots de bois",
      "Manger des boules d'akassa enveloppées dans des feuilles pliées d'une certaine façon (Alvi do gudo)",
      "Toucher la liane Agbakan",
      "Chien, coq, Lopard, Aklassu, Buffle",
      "Brûler le bois d'iroko"
    ],
    sacrifices: ["Adorer Hoho (jumeaux)", "Les ftiches Lgba, Hbiosso", "Annuellement, faire des offrandes aux jumeaux"],
    // Suite AKLAN-MEDJI commentaire
  ...
  },
  {
    ...
    sacrifices: [
      ...
      "Exécuter les sacrifices Vonsissa",
      "Chaque année, faire des offrandes d'akassa ou de la bouillie de maïs sucrée et de poissons"
    ],
  ...
  },
  {
    ...
    tonGeneral: "plutot_favorable",
    fetiches: ["Gbadu", "N", "Az", "Kinessi", "Tohossu", "Yalod", "Naawo", "Lissa", "Loko"],
    feuillesLiturgiques: ["Avkanfunm", "Gnonussissi", "Zom", "Zzm", "Ajassiafv (fon)"],
    couleursPreferes: ["Rouge (principale)", "Blanc", "Bleu"],
    devises: [
      "Attin ku t, moin ma ku t. Tous les arbres se noient, mais le bambou résiste. Le fa vi échappera toujours à ses ennemis."
    ],
    interdits: [
      "Azin gokwin (poisson fumé et recourbé)",
      "Hu hiha",
      "Patate douce",
      "Serpents de toute espèce",
      "Crocodile",
      "Ihui (pangolin)",
      "Escargot",
      "Oiseau agbogbo",
      "Les singes Haa, Klan, Zinwo (la violation de ce dernier interdit sera sanctionnée par la mort de l'enfant du coupable)"
    ],
    sacrifices: [
      "Adorer Tohossou, D, Hoho et Gu",
      "Abandonner l'eau des offrandes (Tohossou gban, Dangban)",
      "Faire annuellement de l'aumône aux forgerons et des sacrifices aux jumeaux"
    ],
