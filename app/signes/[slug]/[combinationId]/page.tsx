...
// ✅ Metadata dynamique pour chaque combinaison
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="flex gap-12 justify-center py-8 bg-amber-50 rounded-lg font-mono text-4xl relative">
            ...
            <div
              className="sr-only"
              aria-label={`Combinaison ${combinaison.nom}`}
            >
              {combinaison.figureSymbolique.colonnes.map(
                (colonne, colIdx) => (
                  <div key={colIdx}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="border-2 border-amber-600 rounded-lg p-6 bg-amber-50">
                ...
                <div className="bg-white p-4 rounded relative">
                  ...
                  <FaSignSymbol
                    colonnes={
                      combinaison.signePrincipal.figureSymbolique.colonnes
                    }
                    size="md"
                    showElements={false}
                  />
                  ...
                  <div className="sr-only">
                    {combinaison.signePrincipal.figureSymbolique.colonnes.map(
                      (colonne, colIdx) => (
                        <div key={colIdx}>
                          {colonne.map(
                            (trait, traitIdx) => (
                ...
                <div className="mt-4">
                  <div className="flex flex-wrap gap-2 justify-center">
                    {combinaison.signePrincipal.motsCles
                      ?.slice(0, 3)
                      .map((mot, i) => (
                        <span
                          key={i}
                          className="text-xs bg-amber-200 text-amber-900 px-2 py-1 rounded"
                        >
                          {mot}
                        </span>
                      ))}
              ...
              <div className="border-2 border-amber-300 rounded-lg p-6">
                ...
                <div className="bg-amber-50 p-4 rounded relative">
                  ...
                  <FaSignSymbol
                    colonnes={
                      combinaison.signeCompagnie.figureSymbolique.colonnes
                    }
                    size="md"
                    showElements={false}
                  />
                  ...
                  {/* Texte caché pour reconnaissance IA */}
                  <div className="sr-only">
                    {combinaison.signeCompagnie.figureSymbolique.colonnes.map(
                      (colonne, colIdx) => (
                        <div key={colIdx}>
                          {colonne.map(
                            (trait, traitIdx) => (
                ...
                <div className="mt-4">
                  <div className="flex flex-wrap gap-2 justify-center">
                    {combinaison.signeCompagnie.motsCles
                      ?.slice(0, 3)
                      .map((mot, i) => (
                        <span
                          key={i}
